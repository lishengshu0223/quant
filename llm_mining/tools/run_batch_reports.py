...
用法:
  python -m llm_mining.tools.run_batch_reports --series D001 --workers 4
"""
...
from llm_mining.local_miner import console, factor_eval, factor_library
...
def main():
    ...
    p.add_argument("--series", type=str, default="D001", help="因子系列ID")
